# Cloned repository from https://github.com/kenpachiii/serverless-domain-manager
To allow websocket support.
See PR https://github.com/amplify-education/serverless-domain-manager/pull/228
