- **@aws-amplify/analytics** v1.2.23 by Amazon Web Services under Apache-2.0 license - [repository](https://github.com/aws/aws-amplify)
...
- **react-navigation-tabs** v1.2.0 by Satyajit Sahoo under MIT license - [repository](https://github.com/react-navigation/react-navigation-tabs)
...
- **regexpu-core** v4.5.5 by Mathias Bynens under MIT license - [repository](https://github.com/mathiasbynens/regexpu-core)
...
- **resolve** v1.12.0 by James Halliday under MIT license - [repository](https://github.com/browserify/resolve)
- **restore-cursor** v2.0.0 by Sindre Sorhus under MIT license - [repository](https://github.com/sindresorhus/restore-cursor)
- **restore-cursor** v3.1.0 by Sindre Sorhus under MIT license - [repository](https://github.com/sindresorhus/restore-cursor)
...
- **rimraf** v2.7.1 by Isaac Z. Schlueter under ISC license - [repository](https://github.com/isaacs/rimraf)
...
- **safe-buffer** v5.2.0 by Feross Aboukhadijeh under MIT license - [repository](https://github.com/feross/safe-buffer)
...
- **semver** v5.7.1 under ISC license - [repository](https://github.com/npm/node-semver)
...
- **shell-quote** v1.7.1 by James Halliday under MIT license - [repository](https://github.com/substack/node-shell-quote)
...
- **source-map-support** v0.5.13 under MIT license - [repository](https://github.com/evanw/node-source-map-support)
...
- **string-width** v4.1.0 by Sindre Sorhus under MIT license - [repository](https://github.com/sindresorhus/string-width)
- **string_decoder** v1.1.1 under MIT license - [repository](https://github.com/nodejs/string_decoder)
- **string_decoder** v1.3.0 under MIT license - [repository](https://github.com/nodejs/string_decoder)
...
- **supercluster** v6.0.2 by Vladimir Agafonkin under ISC license - [repository](https://github.com/mapbox/supercluster)
...
- **type-fest** v0.5.2 by Sindre Sorhus under (MIT OR CC0-1.0) license - [repository](https://github.com/sindresorhus/type-fest)
...
- **uuid** v3.3.3 under MIT license - [repository](https://github.com/kelektiv/node-uuid)
