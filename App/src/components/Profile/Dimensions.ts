...
// export const HEADER_IMAGE_HEIGHT = Dimensions.get("screen").width;
// export const MEMBER_HEADER_HEIGHT = HEADER_IMAGE_HEIGHT /* picture */ + 112 + 56.5 + 16;
// export const MEMBER_HEADER_SCROLL_HEIGHT = HEADER_IMAGE_HEIGHT;
