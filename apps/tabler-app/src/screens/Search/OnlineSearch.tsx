        ...
        return (
            <Query<SearchMember, SearchMemberVariables>
                ...
                variables={{
                    ...
                    associations: this.props.filterTags.filter((f: FilterTag) => f.type === 'association').map((f: FilterTag) => f.id!),
                    areas: this.props.filterTags.filter((f: FilterTag) => f.type === 'area').map((f: FilterTag) => f.id!),
                    clubs: this.props.filterTags.filter((f: FilterTag) => f.type === 'table').map((f: FilterTag) => f.id!),
